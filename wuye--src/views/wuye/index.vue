...
.wuye{font-family: PingFangSC-Regular;width: 100%;height: 800px;
      background-color:#e0e0e038;font-size: 14px;text-align: center}
    ...
    <div class="wuye">
        <swiper :options="swiperOption" ref="mySwiper">
            <swiper-slide>
                <div class="ban1">
                    <router-link to="/" >
                        <img src="../../static/image/wuye/ysqban.png" alt="tt">
                    </router-link>                  
                </div> 
            </swiper-slide>
            ...
            <ul>
                <li class="jgg_li" >
                    ...
                    <router-link to="/pay" class="link">
                        <div class="jgg_img">
                            <img src="static/image/wuye/wyjf1.png" alt="tt">
                        </div>
                ...
                <li class="jgg_li" >    
                    <router-link to="/paystop" class="link">
                        <div class="jgg_img">
                            <img src="static/image/wuye/tcjf1.png" alt="tt">
                        </div>
                ...
                <li class="jgg_li" >
                    <a v-bind:href="jfcx">
                        <div class="jgg_img">
                            <img src="static/image/wuye/jfcx1.png" alt="tt">
                        </div>
                ...
                <li class="jgg_li" >
                    <router-link to="/myhouse" class="link">
                        <div class="jgg_img">
                            <img src="static/image/wuye/wsyz1.png" alt="tt">
                        </div>
                ...
                <li class="jgg_li" >
                    <router-link :to="{path:'/suggest',query:{category:9}}" class="link">
                        <div class="jgg_img">
                            <img src="static/image/wuye/yzyj1.png" alt="tt">
                        </div>
...
export default {
    ...
    data () {
        return {
            ...
            //过佳家
            jfcx:"https://test.e-shequ.com/guangming/weixin/wuye/paymentquery.html",
            zixun:"https://test.e-shequ.com/guangming/weixin/wuye/message.html?messageId=",
